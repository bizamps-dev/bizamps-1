    ...
    <>
             ...
             <div className={styles.blogContainer}>             
                <div className={styles.blogContainer2}>
                  ...
                  <h2 style={{fontFamily:"Roboto", marginBottom:"0.5rem",marginLeft:"0rem"  }}>Problem:</h2>
                  <p>The client was unable to outsource any leads even after hiring a highly networked sales partner.</p>
                  <br></br>

                  <h2 style={{fontFamily:"Roboto", marginBottom:"0.5rem",marginLeft:"0rem"  }}>Channel:</h2>
                  ...
                  <h2 style={{fontFamily:"Roboto", marginBottom:"0.5rem",marginLeft:"0rem"  }}>Accomplishments:</h2>
                  <p>The client was able to engage with 10% of the entire target market immediately.</p>
                  <br></br>

                  <h2 style={{fontFamily:"Roboto", marginBottom:"0.5rem",marginLeft:"0rem"  }}>Key Bottlenecks:</h2>
                  ...
                  <h2 style={{fontFamily:"Roboto", marginBottom:"0.5rem",marginLeft:"0rem"  }}>Client outreach replies</h2>  
...
export const BlogLedgenQuery = graphql`
  query {
    ...
    bg1: file(relativePath: { eq: "InternationalInstituteBG.png" }) {
        childImageSharp {
          fluid(maxWidth: 1000) {
            ...GatsbyImageSharpFluid
          }
