             ...
             >
              <div className={styles.blogContainer}>             
                <div className={styles.blogContainer2}>
                  ...
                  <p className={styles.QuestionBlog2} style={{fontFamily:"Libre Baskerville",fontSize:"3rem" }}>"Don’t judge each day by the harvest you reap but by the seeds you plant."</p>
                  ...
                  <p>· This blog does not tell you ‘how to do it’ but tells you ‘what to do’ </p><br></br>
                  <p>· This blog contains enough information you need to start your own sales agency.</p><br></br>
                  <p>So, let's begin!  </p>

                  <p style={{fontFamily:"Roboto",fontSize:"2rem" }}><b></b>1. Channel and Cadence. </p>
